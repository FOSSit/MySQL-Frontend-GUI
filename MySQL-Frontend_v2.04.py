...
class delete_db_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/delete_DB_confirmation.ui",self)
...
class delete_data_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/delete_DATA.ui",self)
        self.fetch_DATA()
...
class delete_tb_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/delete_TB_confirmation.ui",self)
...
class delete_Column_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/delete_col_confirmation.ui",self)
...
class rename_tb_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/rename_TB_confirmation.ui",self)
        self.next.clicked.connect(self.goFwd)
        self.previous.clicked.connect(self.goBack)
...
class rename_Col_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/rename_col_confirmation.ui",self)
        self.fetchColumns()
...
class display_table(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/display_TB.ui",self)
...
class selectiveDisplay_table(QDialog):
    ...
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/selectiveDisplay_TB.ui",self)
        self.fetchColumns()
        self.fetchTB()
...
class supportedQueries(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/supportedQueriesDialog.ui',self)
...
class rename_db_confirmation(QDialog):
    def __init__(self,parent=None):
        ...
        loadUi("./Src/UI/rename_DB_confirmation.ui",self)
...
class update_table_confirmation_querybox(QDialog):
    ...
    def __init__(self):
        ...
        loadUi('./Src/UI/update_TB_QUERIESDialog.ui',self)
    ...
    def textPopup2(self,item): # popup window allowing user to edit queries for exec method execute2()
        ...
        dlg.setWindowIcon(QtGui.QIcon(QtGui.QPixmap('./Src/PNG/icon.png')))
...
class wel_Login_scr(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/login_02.ui', self)
...
class MainWindow(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/main-window.ui',self)
        self.Error.setText("")
...
class update_DATA(QDialog):
    ...
    def __init__(self):
        ...
        loadUi("./Src/UI/update_TB.ui",self)
...
class Add_tb_column(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/add_TB_column.ui',self)
...
class insert_Data(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/insert_DATA.ui', self)
    ...
    def append_str(self):
        ...
        if len(query) == 0:
            if text == "" or text == None:
                ...
                self.display_tabWidget.setTabIcon(0,QtGui.QIcon("./Src/PNG/warning.png"))
        ...
        if query == '':
            ...
            if words[0].lower()=='insert' and words[1].lower()=='into' and words[2].lower()== DB_TB_choice[1].lower():
                try:
                    ...
                    self.display_tabWidget.setTabIcon(0,QtGui.QIcon("./Src/PNG/tick.png"))
                    self.Querybox.clear()
...
class modify_tb_column(QDialog):
    def __init__(self):
        ...
        loadUi('./Src/UI/modify_TB_column.ui',self)
        self.executor.clicked.connect(self.execute)
        self.display_tabWidget.setTabIcon(0,QtGui.QIcon(QtGui.QPixmap(1,1)))
